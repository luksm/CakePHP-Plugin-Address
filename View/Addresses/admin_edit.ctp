...
<div class="actions">
    ...
    <ul>
		<li><?php echo $this->Form->postLink(__d('address', 'Delete'), array('action' => 'delete', $this->Form->value('Address.id')), null, __d('address', 'Are you sure you want to delete # %s?', $this->Form->value('Address.id'))); ?></li>
