<div class="addresses index">
    ...
    <tr>
        ...
        <td><?php echo $this->Html->link($address['Neighbourhood']['neighbourhood'], array('controller' => 'neighbourhoods', 'action' => 'view', $address['Neighbourhood']['id'])); ?></td>
        <td><?php echo $this->Html->link($address['Neighbourhood']['City']['city'] . " - " . $address['Neighbourhood']['City']['State']['fu'], array('controller' => 'cities', 'action' => 'view', $address['Neighbourhood']['City']['id'])); ?></td>
        <td class="actions">
